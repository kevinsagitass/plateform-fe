  ...
  return (
    <AnimatePresence>
      {isOpen && (
        ...
        >
          <motion.div
            className="w-full max-w-md bg-white dark:bg-neutral-900 rounded-2xl shadow-modal border border-neutral-200 dark:border-neutral-700"
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`
                        ...
                        ${
                          errors.tenantName
                            ? "border-red-300 dark:border-red-700 focus:ring-red-200 dark:focus:ring-red-900/40 focus:border-red-400 dark:focus:border-red-600"
